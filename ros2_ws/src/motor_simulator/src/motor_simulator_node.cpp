...
public:
    MotorSimulatorNode()
        ...
        true_velocity_publisher_ = 
            this->create_publisher<std_msgs::msg::Float64>("true_velocity", 10);
...
private:
    void data_publish() {
        ...
        std_msgs::msg::Float64 true_velocity_msg;
        true_velocity_msg.set__data(motor_model_.get_true_velocity());
        true_velocity_publisher_->publish(true_velocity_msg);
    }
    ...
    rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr true_velocity_publisher_;
